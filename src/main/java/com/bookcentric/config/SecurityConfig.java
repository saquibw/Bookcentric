	...
	protected void configure(HttpSecurity http) throws Exception {
		http.
			authorizeRequests()
				...
				.antMatchers("/author/**", "/genre/**", "/tag/**", "/publisher/**", "/reading-challenge/management/**").hasRole("ADMIN")
				...
				.antMatchers("/donate-books/**", "/gift-subscription/**", "/coming-soon/**", "/reviews/other/**").permitAll()
